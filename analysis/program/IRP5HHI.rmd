...
Fadata <- FAD[num == 1L, 
  grepout("^bus|^tax[ry]|^Tx|Mon|Num|Jo|Emp|FA", colnames(FAD)), 
  with = F]
...
aggsum <- 
  aggsummary[, .(
    ...
    , TotalAffectedFirms      = sum(TotalAffectedFirms)
        ...
        taxyear,
        TotalJobs, TotalSubMWJobs, 
        TotalFirmsWithEmployee, TotalAffectedFirms
      , AggregateFA           = round((TotalSubMWWorkers/TotalEmployees)*100, 2)
    )
  ]
