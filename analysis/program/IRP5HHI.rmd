...
FAD[, num := 1:.N, by = .(busprov_geo, busdistmuni_geo, 
  buslocmuni_geo, busmainplc_geo, taxrefno, payerrefno, taxyear)]
Fadata <- FAD[num == 1L, ]
...
tb <- tt(aggsum, width = 0.8, caption = "Jobs and sub-MW jobs")
...
#### Jobs
#### fadatai <- qread(paste0(pathdata, "FAAndJobs.qs""), nthreads = 13)
#### estfa <- 
