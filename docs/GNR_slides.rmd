...
BibOptions(check.entries = FALSE,
           ...
           hyperlink = FALSE,
           dashed = FALSE)
## Uncomment below for the 1st run of each R session. 2nd run will get cached results.
...
* It means we must do it with VA or VA-Leontief-in-materials `r Citep(myBib, "Rubens2023")`. ACJ way.  

--

* When are materials substitutable with capital and labour? Energy. But not coffee beans for coffee. 

--

* Why do we exclude intermediate inputs from a production function? Because grapes are entirely subsumed in wines and do not provide services as capital and labour do.  

--

* A production function is intended to explain the value added, so it is a relationship between service inputs and outputs... (Materials do not provide value added be definition: VA = value - material input value.)
